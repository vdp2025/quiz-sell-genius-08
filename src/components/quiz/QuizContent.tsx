...
export const QuizContent: React.FC<QuizContentProps> = ({
  ...
  return <>
      ...
      <div className="container mx-auto w-full max-w-5xl py-0 px-[4px]">
        {showingStrategicQuestions ? <StrategicQuestions currentQuestionIndex={currentStrategicQuestionIndex} answers={{}} onAnswer={handleAnswerSubmit} onNextClick={handleNextClick} /> : <QuizQuestion question={currentQuestion} onAnswer={handleAnswerSubmit} currentAnswers={currentAnswers || []} onNextClick={handleNextClick} showQuestionImage={true} onPreviousClick={handlePrevious} autoAdvance={true} />}
      </div>
    </>;
};