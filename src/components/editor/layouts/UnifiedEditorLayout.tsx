...
import { TemplateSelector } from '@/components/result-editor/TemplateSelector';
...
export const UnifiedEditorLayout: React.FC<UnifiedEditorLayoutProps> = ({ primaryStyle }) => {
  ...
  const { config, addBlock, updateBlock, deleteBlock, saveConfig, updateConfig } = useEditor();
    ...
    <div className="h-screen flex flex-col">
      ...
      <ResizablePanelGroup direction="horizontal" className="flex-1">
        ...
        <ResizablePanel defaultSize={55}>
          <TemplateSelector
            currentStyle={primaryStyle.category}
