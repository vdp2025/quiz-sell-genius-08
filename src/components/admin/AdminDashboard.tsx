        ...
        <div className="mt-10 bg-white p-6 rounded-lg shadow-sm border border-[#B89B7A]/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Link 
              ...
              className="p-4 border border-[#B89B7A]/30 rounded-lg hover:bg-[#FAF9F7] transition-colors"
            >
              <h3 className="font-medium text-[#432818]">Gerenciar Quizzes</h3>
              <p className="text-sm text-[#8F7A6A] mt-1">Visualize e edite seus quizzes existentes</p>
            </Link>
            ...
            <Link 
              to="/admin/unified-editor/template1" 
              className="p-4 border border-[#B89B7A]/30 rounded-lg hover:bg-[#FAF9F7] transition-colors"
            >
              <h3 className="font-medium text-[#432818]">Editar Quiz Ativo</h3>
              <p className="text-sm text-[#8F7A6A] mt-1">Faça alterações no seu quiz de estilo pessoal</p>
            </Link>
          </div>
        </div>
      </div>
