...
const bonuses: BonusItemProps[] = [
  {
    ...
    features: [
      ...
      "Guia de combinações versáteis",
      "Onde encontrar por preços acessíveis",
      "Como avaliar a qualidade das peças"
    ]
  },
  {
    ...
    features: [
      ...
      "Recomendações de cortes de cabelo",
      "Técnicas de maquiagem para valorizar",
      "Escolha de acessórios ideais"
    ]
  },
];
    ...
    <section className="py-10">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {bonuses.map((bonus, index) => (
          <Card 
            key={index} 
            className={`card-elegant overflow-hidden relative ${bonus.isPremium ? 'border-2 border-[#B89B7A]' : 'border border-[#B89B7A]/20'}`}
          >
            {bonus.isPremium && (
              <div className="absolute top-0 right-0 bg-[#B89B7A] text-white px-4 py-1 transform translate-x-8 translate-y-2 rotate-45 shadow-md">
              ...
              <div className="border-t border-[#B89B7A]/10 pt-3 mt-3">
                <h4 className="flex items-center gap-2 font-medium text-[#432818]">
                  {bonus.isPremium ? (
                    ...
                    <Star className="w-5 h-5 text-[#B89B7A]" />
                  )}
                  O que está incluído:
                </h4>
