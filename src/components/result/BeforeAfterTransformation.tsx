      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-left md:w-1/2">
            <h2 className="text-2xl md:text-3xl font-playfair text-[#aa6b5d] mb-2 text-center py-[18px] mx-0">
          ...
          }} onMouseEnter={() => setIsButtonHovered(true)} onMouseLeave={() => setIsButtonHovered(false)} aria-label="Quero Descobrir Meu Guia Completo" className="text-white px-6 rounded-md transition-all duration-300 w-full md:w-auto py-[22px] bg-[#1ba11b]">
          ...
          <div className="md:w-1/2 w-full">
            <Card className="p-6 card-elegant overflow-hidden">
              ...
              <div className={`relative h-[400px] md:h-[500px] w-full mb-4 ${areImagesReady ? '' : 'hidden'}`}>
                <img src={activeTransformation.afterImage} alt={`Transformação - ${activeTransformation.name}`} className="w-full h-full object-cover rounded-lg shadow-md" loading="eager" fetchPriority="high" />
