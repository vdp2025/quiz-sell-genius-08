        ...
        <div className="flex flex-col h-full border rounded-lg shadow-sm">
          ...
          <div className="flex-1 p-4 overflow-auto">
            ...
            {tabParam === 'result' && (
              <div className="h-full flex items-center justify-center border-2 border-dashed border-gray-300 rounded-lg">
                <div className="text-center">
                  <h2 className="text-xl font-semibold mb-2">Editor de Resultados</h2>
                  <p className="text-gray-600">Este é o novo editor simplificado para a página de Resultados</p>
                </div>
              </div>
            )}
