...
const ResultPage: React.FC = () => {
  ...
  return (
  <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: globalStyles.backgroundColor || '#fffaf7', color: globalStyles.textColor || '#432818', fontFamily: globalStyles.fontFamily || 'inherit' }}>
      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl relative z-10">
        ...
        <div className="text-center mt-10">
          ...
          <p className="text-[#432818] mb-6 max-w-xl mx-auto">
            O Guia da Gisele Galvão foi criado para mulheres que querem vestir sua essência, com clareza, confiança e direção.
          </p>

          <Button
            onClick={handleCTAClick}
            className="text-white py-4 px-8 rounded-md"
            style={{ background: "linear-gradient(to right, #4CAF50, #45a049)", boxShadow: "0 4px 14px rgba(76, 175, 80, 0.4)" }}
            onMouseEnter={() => setIsButtonHovered(true)}
            onMouseLeave={() => setIsButtonHovered(false)}
          >
            <span className="flex items-center justify-center gap-2">
              <ShoppingCart className={`w-5 h-5 transition-transform duration-300 ${isButtonHovered ? 'scale-110' : ''}`} />
              Garantir Meu Guia + Bônus por R$39,00
            </span>
          </Button>
